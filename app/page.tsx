...
export default function HomePage() {
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 font-sans transition-colors duration-200">
      ...
      {/* HERO SECTION */}
      <section className="relative pt-24 sm:pt-32 pb-14 sm:pb-20 overflow-hidden border-b border-slate-200 dark:border-slate-800/80">
        
        {/* Subtle Background Glow */}
        <div className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[320px] sm:w-[500px] h-[200px] sm:h-[300px] bg-orange-500/10 rounded-full blur-[120px] pointer-events-none"></div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 sm:gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-5 sm:space-y-6">
              ...
              <div className="inline-flex items-center gap-2 px-3 py-1 sm:px-3.5 sm:py-1.5 rounded-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-[10px] sm:text-xs font-mono text-orange-600 dark:text-orange-400 shadow-sm">
                <Globe className="w-3.5 h-3.5 shrink-0" />
                <span className="truncate">PAKISTAN CLIMATE RESEARCH PROJECT (1961 – 2037)</span>
              </div>
              ...
              <p className="text-slate-600 dark:text-slate-300 text-xs sm:text-base leading-relaxed max-w-2xl font-normal">
              ...
              <div className="pt-2 flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4">
                <Link
                  href="/dashboard"
                  className="px-6 py-3.5 rounded-full bg-orange-600 hover:bg-orange-500 text-white text-xs sm:text-sm font-bold shadow-md shadow-orange-600/20 transition-all flex items-center justify-center gap-2 group text-center"
                >
                ...
                <Link
                  href="/solutions"
                  className="px-5 py-3.5 rounded-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 hover:bg-slate-100 dark:hover:bg-slate-800 text-slate-800 dark:text-slate-200 text-xs sm:text-sm font-semibold transition-colors shadow-sm text-center"
                >
              ...
              <div className="pt-5 border-t border-slate-200 dark:border-slate-800/80 grid grid-cols-1 sm:grid-cols-3 gap-3.5 sm:gap-4 text-xs font-mono">
                <div className="bg-white/60 dark:bg-slate-900/40 p-2.5 rounded-xl border border-slate-200/60 dark:border-slate-800/60 sm:border-none sm:p-0">
                  <span className="text-slate-500 dark:text-slate-400 block text-[10px] uppercase">Historical Coverage</span>
                  <span className="text-slate-900 dark:text-white font-bold text-xs sm:text-sm">1961 – 2017</span>
                </div>
                <div className="bg-white/60 dark:bg-slate-900/40 p-2.5 rounded-xl border border-slate-200/60 dark:border-slate-800/60 sm:border-none sm:p-0">
                  <span className="text-slate-500 dark:text-slate-400 block text-[10px] uppercase">Warming Rate</span>
                  <span className="text-orange-600 dark:text-orange-400 font-bold text-xs sm:text-sm">+0.191°C / dec</span>
                </div>
                <div className="bg-white/60 dark:bg-slate-900/40 p-2.5 rounded-xl border border-slate-200/60 dark:border-slate-800/60 sm:border-none sm:p-0">
                  <span className="text-slate-500 dark:text-slate-400 block text-[10px] uppercase">Forecast Horizon</span>
                  <span className="text-cyan-700 dark:text-cyan-400 font-bold text-xs sm:text-sm">2017 – 2037</span>
                </div>
              </div>
            ...
            <div className="lg:col-span-5 relative">
              <div className="relative rounded-2xl overflow-hidden border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-2 sm:p-2.5 shadow-xl">
                <div className="relative aspect-[16/10] sm:aspect-[4/3] rounded-xl overflow-hidden">
                  <Image
                ...
                <div className="p-3 bg-slate-50 dark:bg-slate-950 border-t border-slate-200 dark:border-slate-800 flex items-center justify-between text-xs font-mono">
                  <div className="flex items-center gap-2">
                    <Thermometer className="w-4 h-4 text-rose-600 dark:text-rose-500 shrink-0" />
                    <div>
                      <span className="text-[9px] sm:text-[10px] text-slate-500 dark:text-slate-400 block">PEAK RECORD (JACOBABAD)</span>
                      <span className="text-rose-600 dark:text-rose-400 font-bold text-xs">52.6°C Recorded</span>
                    </div>
                  </div>
                  <Link href="/dashboard" className="text-orange-600 dark:text-orange-400 hover:underline font-bold text-[11px] flex items-center gap-1 shrink-0">
                    <span>Open Map</span>
